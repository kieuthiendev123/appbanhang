...
import com.example.mrbuggy.appbanhangonlie.adapter.DienThoaiAdapter;
...
public class DienThoaiAcitity extends AppCompatActivity {
    Toolbar toolbar;
    ListView lvDt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dien_thoai_acitity);
        anhXa();
    ...
    private void anhXa() {
        toolbar =  (Toolbar) findViewById(R.id.tbMobile);
        lvDt = (ListView) findViewById(R.id.lvDienThoai);
        arrayList =  new ArrayList<>();
        dienThoaiAdapter = new DienThoaiAdapter(getApplicationContext(),arrayList);
                ...
                if(response != null && response.length() != 2){
                    ...
                    try {
                        ...
                        for(int i = 0; i<jsonArray.length();i++){
                            ...
                            idDTsp = jsonObject.getInt("idsanpham");
                            arrayList.add(new Sanphamnew(id,tenDT,giaDT,hinhAnhDT,moTaDT,idDTsp));
